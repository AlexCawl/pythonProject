...
phone_book["Jill"] = 456
print(phone_book)  # Объясните результат: (пере)записываем запись в словаре по ключу "Jill" с новым значением 456
phone_book.update({"Jill": "888"}) # Альтернатива присваиванию, обновляет данные, заменяя значения при совпадении ключей

# Выведите все имена из телефонной книги
