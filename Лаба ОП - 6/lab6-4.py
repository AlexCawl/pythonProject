...
f = open("Связанные файлы/input.txt", "r")  # здесь мы открываем файл "input.txt"
...
for line in f.readlines():  # чтение построчно
    print(line.strip())  # выведите каждую строку

f1 = open("Связанные файлы/input1.txt", "r")
print(f1.readline()) # выведите только первую строку input1.txt. Не забудьте закрыть файл
...
if __name__ == "__main__":
    f = open("Связанные файлы/output.txt", 'w')  # добавьте нужный аргумент
